...
Follow along with the [IPython notebook version](https://github.com/wardi/bar_foo/blob/master/bar_foo.ipynb) if you would like to play with the code examples.
